...
s32   os_message_queue_receive(s32 queueid, u32 *message, u32 flags);
s32   os_message_queue_send(s32 queueid, u32 message, s32 flags);
s32   os_message_queue_now(s32 queueid, u32 message, s32 flags);
